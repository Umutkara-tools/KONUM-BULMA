...
<html>
 ...
 .body{
  background-image:url("https://images2.alphacoders.com/480/480538.png");
 }
  </style>
 </head>
 <body class='body'>
  <center>
   <div class="div1">
    <p class="text">
     ...
     <input class="input" name="realnumber" placeholder="05xx xxx xx xx" type="text"/><br>
     ...
     border: none; 
     height: 40px; 
    border-radius: 5px;">KONUMU BUL</button></p>
